...
void shadow(const TGraph*, const TGraph*, const TGraph*, TMultiGraph *, short, double, double, double);
...
void plot_uf_cc() 
{
	...
	//define the canvas
	TCanvas *c1 = new TCanvas("c1", "UFF", 0, 0, 1600, 900);
//	c1->SetGrid();
//	c1->SetLeftMargin(0.01);
	...
	//define the legend	
	TLegend *leg = new TLegend(0.3, 0.75, 0.98, 0.95, NULL, "brNDC");
	leg->SetNColumns(4);
	leg->SetBorderSize(0);
	...
	cal_uf(ufc12c12_henning, z1, a1, z2, a2, "henning/henning_c12c12_cc.dat", 0.9e-3, "c12c12/cross.dat", z1ref, a1ref, z2ref, a2ref, "c12c12/cross.dat");

	z1 = 6, z2 = 6, a1 = 12, a2 = 13;  
	cal_uf(ufc12c13_henning, z1, a1, z2, a2, "henning/henning_c12c13_cc.dat", 0.9e-3, "c12c13/cross.dat", z1ref, a1ref, z2ref, a2ref, "c12c12/cross.dat");
...
//	TGraph *ufc13c13_tdhf = new TGraph(100);
	...
	z1=6, z2=6, a1=12, a2=12;
	cal_uf(ufc12c12_tdhf,z1,a1,z2,a2,"tdhf/x_12C_12C_amc2_931.out",1e-3,"c12c12/cross.dat",z1ref,a1ref,z2ref,a2ref,"c12c12/cross.dat");

	z1=6, z2=6, a1=12, a2=13;
	cal_uf(ufc12c13_tdhf,z1,a1,z2,a2,"tdhf/x_12C_13C_amc2_931.out",1e-3,"c12c13/cross.dat",z1ref,a1ref,z2ref,a2ref,"c12c12/cross.dat");

	ufc12c12_tdhf->SetLineColor(kBlack);
...
//	cal_uf(ufc12c12spp,z1,a1,z2,a2,"c12c12/cross.dat",1, "c12c12/cross.dat",z1ref,a1ref,z2ref,a2ref,"c12c12/cross.dat");
	...
	mg->GetYaxis()->SetRangeUser(0 ,1.1e17);
	...
	mg->GetXaxis()->SetTitleOffset(0.55);
	...
	TLatex *tex2 = new TLatex(1.,68e+015,"TDHF");
	tex2->Draw();
...
void shadow(const TGraph* tge1, const TGraph* tge2,const  TGraph* tge3, TMultiGraph *mg, short color, double xl, double xh, double xcoeff)
{
	Double_t ymax[100], ymin[100],ydown[100];
	Double_t xmax, xmin, dx;
	Double_t x0[100] = {0}, y0[100] = {0}, y1[100], y2[100], y3[100];
