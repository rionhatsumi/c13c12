...
void plot_uf_cc() 
{
	...
	TLegend *leg = new TLegend(0.78, 0.55, .98, .95);
//	leg->SetFillColor(10);
	leg->SetBorderSize(0);
	...
	*/
	...
	//	cal_uf(ufc12c13_dn,z1,a1,z2,a2,"tdhf/x_12C_13C.out",0.8e-3,"c12c13/cross.dat",z1ref,a1ref,z2ref,a2ref,"c12c12/cross.dat");
		...
		leg->AddEntry(ufc13c13, "^{12}C+^{14}C", "l");
	}
...
//	cal_uf(ufc12c13_esw,z1,a1,z2,a2,"esw/c12c13_esw_dayras.xsec",1,"c12c13/cross.dat",z1ref,a1ref,z2ref,a2ref,"c12c12/cross.dat");
	...
	leg->AddEntry(ufc12c13_esw, "esw ^{12}C+^{13}C", "l");
	leg->AddEntry(ufc13c13_esw, "esw ^{13}C+^{13}C", "l");
	leg->Draw();	
	// plot esw 
...
void plot_exp_c12c13_data(TLegend *leg) {
	...
	leg->AddEntry(gr_c12c13_st, "st ^{12}C+^{13}C", "p");
	leg->AddEntry(gr_c12c13_imp, "imp ^{12}C+^{13}C", "p");
