...
void plot_normalize()
{
	...
	//define TLegend
	TLegend *leg = new TLegend(0.32, 0.62, 0.95, 0.95);
	TLegend *leg2 = new TLegend(0.45, 0.75, 0.95, 0.95);
	TLegend *leg3 = new TLegend(0.45, 0.65, 0.95, 0.95);
	leg->SetNColumns(3);
//	leg->SetFillColor(10);
	leg->SetBorderSize(0);
...
//	leg2->SetFillColor(10);
	...
	h2_sfactor->GetXaxis()->SetTitleSize(0.10);
	h2_sfactor->GetXaxis()->SetTitleOffset(0.75);
	...
	h2_sfactor->GetYaxis()->SetTitleSize(0.10);
	h2_sfactor->GetYaxis()->SetTitleOffset(0.5);
	h2_sfactor->GetYaxis()->SetTitleFont(132);
	h2_sfactor->GetYaxis()->SetRangeUser(1e14, 5e17);
...
void plot_m3y_n(TLegend *leg) {
	...
	gr_c12c12_n->SetLineColor(kBlue);
	gr_c12c13_n->SetLineColor(kBlue);
	gr_c13c13_n->SetLineColor(kBlue);
...
//	gr_c12c12_n->Print("all");
	leg->AddEntry(gr_c12c12_n, "M3Y+Rep", "L");
}
...
void plot_tdhf_n(TLegend *leg) {
	...
	gr_c12c12_n->SetLineColor(kGreen+2);
	gr_c12c13_n->SetLineColor(kGreen+2);
...
void plot_kns(TLegend *leg) {
	...
	gr_c12c12_kns->SetLineColor(kBlue);
	gr_c12c12_kns->SetLineWidth(2);
	gr_c12c12_kns->SetLineStyle(kDashed);

	gr_c12c12_kns->Draw("C");
	leg->AddEntry(gr_c12c12_kns, "KNS", "L");
}
